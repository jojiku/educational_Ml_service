...
class PredictionFeatures(BaseModel):
    merchant_id: int = Field(..., description="gender for the prediction.")
    cluster_id: int = Field(..., description="work for the prediction.")


class PredictionTarget(BaseModel):
    category_id: int = Field(..., description="Predicted age group.")
    category_label: Optional[str] = Field(None, description="Label of the predicted age group.")
