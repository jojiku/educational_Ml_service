...
from front.data.local_data import authentificated_session
from front.data.remote_data import fetch_predictions_reports, fetch_users_report, fetch_credits_report
from front.data.remote_data import deposit_amount, send_prediction_request, \
    fetch_prediction_history, register_user, fetch_models, authenticate_user, fetch_user_balance
from front.ui_kit.components.navigation import navigation_bar
